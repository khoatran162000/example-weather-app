const API_KEY = "M7UFFW2RSUWH7WZSJ8N5NZW62"; // khoá bí mật được web weather.visualcrossing.com cung cấp để mình sử dụng được api
const API_URL = "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline" // API LẤY DỮ LIỆU THỜI TIẾT của 1 thànhh phố
const API_PEXELS = "b4y7EqrsTBlLB20UM0x1hcHrVDDJ6YsTc5iaNqXtDkYQEWLEWbJdnLdC" // api lấy ảnh theo thành phô


const TEMP = document.getElementById("temp"), // alias
